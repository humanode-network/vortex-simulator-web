(() => {
  ...
  const chamberProfiles = {
    "protocol-engineering": {
      ...
      proposals: [
        { name: "Orbital Mesh Sequencer Upgrade", lead: "Mozgiii", stage: "upcoming", window: "Starts in 2h" },
        { name: "Runtime Guardrails", lead: "Dima", stage: "live", window: "Ends in 45m" },
        { name: "Validator Handbook", lead: "Tony", stage: "ended", window: "Closed 8h ago" },
      ],
      governors: ["Mozgiii", "Victor", "Sesh", "Tony", "Dima", "Shannon", "Sasha", "Peter"],
      threads: [
        { title: "Sequencer redundancy rollout", meta: "Mozgiii · 4 replies · Updated 1h ago" },
        { title: "VM verifier benchmarks", meta: "Victor · 11 replies · Updated 3h ago" },
        { title: "Formation slot requests", meta: "Sesh · 6 replies · Updated 6h ago" },
      ],
      chat: [
        { author: "Mozgiii", text: "Milestone 2 patch deployed, please verify." },
        { author: "Victor", text: "Treasury hook live, watching KPIs." },
        { author: "Sesh", text: "Need 2 reviewers for the new biometrics spec." },
      ],
    },
    "research-cryptobiometrics": {
      ...
      proposals: [
        { name: "Liveness Sentinel Retrofit", lead: "Sesh", stage: "live", window: "Ends in 3h" },
        { name: "ZK Attestation Pilot", lead: "Victor", stage: "upcoming", window: "Starts in 6h" },
      ],
      governors: ["Sesh", "Victor", "Mozgiii", "Shannon", "Sasha"],
      threads: [
        { title: "Proof-of-human existence updates", meta: "Sesh · 9 replies · Updated 2h ago" },
        { title: "Optic liveness benchmarks", meta: "Shannon · 5 replies · Updated 5h ago" },
      ],
      chat: [
    ...
    "treasury-economics": {
      ...
      proposals: [
        { name: "Adaptive Fee Shaping", lead: "Victor", stage: "live", window: "Ends in 2h 15m" },
        { name: "Formation Reserve Refill", lead: "Peter", stage: "upcoming", window: "Starts in 10h" },
        { name: "Treasury diversification", lead: "Tony", stage: "ended", window: "Closed 1d ago" },
      ],
      governors: ["Victor", "Peter", "Tony", "Dima", "Sasha"],
      threads: [
        { title: "Adaptive fees testnet feedback", meta: "Victor · 7 replies · Updated 30m ago" },
        { title: "Budget rollovers", meta: "Peter · 3 replies · Updated 4h ago" },
      ],
      chat: [
    ...
    "formation-logistics": {
      ...
      proposals: [
        { name: "Mesh Talent Onboarding Fund", lead: "Tony", stage: "upcoming", window: "Starts in 4h" },
        { name: "Grant Ops Automation", lead: "Peter", stage: "live", window: "Ends in 1d" },
      ],
      governors: ["Tony", "Peter", "Sasha", "Shannon"],
      threads: [
        { title: "Talent onboarding queue", meta: "Tony · 12 replies · Updated 1h ago" },
      ],
      chat: [
        { author: "Tony", text: "Need mentors for batch #12." },
      ],
    },
    "social-outreach": {
      ...
      proposals: [
        { name: "Community Grants Wave", lead: "Sasha", stage: "live", window: "Ends in 12h" },
      ],
      governors: ["Sasha", "Tony", "Peter"],
      threads: [
        { title: "Ambassador rollout", meta: "Sasha · 4 replies · Updated 2h ago" },
      ],
      chat: [
        { author: "Sasha", text: "Need feedback on the AMA deck." },
      ],
    },
    "security-council": {
      eyebrow: "Security",
      ...
      proposals: [
        { name: "Liveness Sentinel Retrofit", lead: "Shannon", stage: "live", window: "Ends in 5h" },
        { name: "Validator Hardening", lead: "Sasha", stage: "ended", window: "Closed 6h ago" },
      ],
      governors: ["Shannon", "Sasha", "Mozgiii", "Victor"],
      threads: [
        { title: "Deterrence drill recap", meta: "Shannon · 8 replies · Updated 3h ago" },
      ],
      chat: [
  ...
  const chamber = chamberProfiles[key] || chamberProfiles["protocol-engineering"];
