...
export function ProposalCreationLineageMessage({
  ...
  return (
    <GlassyCard className="px-4 py-4 text-sm text-muted">
...
export function ProposalCreationMessages({
  ...
  return (
    <>
      {saveError ? (
        <div className="rounded-lg border border-[color:var(--surface-glass-border)] bg-[color:var(--control-glass-bg)] px-4 py-3 text-xs text-muted">
      ...
      {loadDraftError ? (
        <div className="rounded-lg border border-[color:var(--surface-glass-border)] bg-[color:var(--control-glass-bg)] px-4 py-3 text-xs text-destructive">
